...
class HotkeyStore: ObservableObject {
    ...
    @Published var carbonModifiers: UInt32 {
        didSet { UserDefaults.standard.set(Int(carbonModifiers), forKey: "hotkeyModifiers") }
    }

    init() {
        let savedCode = UserDefaults.standard.object(forKey: "hotkeyKeyCode") as? Int
...
extension Notification.Name {
    static let hotkeyChanged = Notification.Name("com.noteflow.hotkeyChanged")
}
